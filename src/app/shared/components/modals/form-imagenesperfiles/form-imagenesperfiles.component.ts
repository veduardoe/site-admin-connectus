...
@Component({
  selector: 'app-form-imagenesperfiles',
  templateUrl: './form-imagenesperfiles.component.html',
  styleUrls: ['./form-imagenesperfiles.component.scss']
})
export class FormImagenesPerfilesComponent implements OnInit {
  ...
  mainForm = new FormGroup({
    ...
    detalleEN: new FormControl(null, [Validators.required]),
  ...
  save() {
    ...
    const prom = (data._id) ? this.imagenesPerfilesService.put(data._id, data) : this.imagenesPerfilesService.post(data);
    prom.then(res => {
